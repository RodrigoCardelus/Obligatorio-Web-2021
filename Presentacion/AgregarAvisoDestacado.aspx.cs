           ...
           try
            {
                ...
                Destacado unDestacado = new Destacado(numero_Interno,codigo_Interno,fecha,listaTelefono,codigo);


                numero_Interno = ((int)LogicaDestacado.Agregar(unDestacado));


                foreach (Telefono t in unDestacado.ListaTelefono)
                {
